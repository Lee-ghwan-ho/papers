...
- **Status**: Published Journal / Accepted Conference / Preprint Only / Workshop Paper  
- **Cat**: A=직접경쟁 / B=방법론유사 / C=구조·혈관특화 / D=Top-tier Vision  
- **Rel**: 내 연구와의 관련성 (High / Medium / Low)  

---

## Category A. 직접 경쟁 — SSDG / Medical Image Segmentation DG

| KEY | 제목 | Venue | Year | Status | Rel |
|-----|------|-------|------|--------|-----|
| SLAUG | Rethinking Data Augmentation for Single-source Domain Generalization in Medical Image Segmentation | TPAMI | 2023 | Published Journal | High |
| CAUSALITY_SDG | Causality-inspired Single-source Domain Generalization for Medical Image Segmentation | IEEE TMI | 2022 | Published Journal | High |
| RAFFESDG | RaffeSDG: Random Frequency Filtering enabled Single-source Domain Generalization for Medical Image Segmentation | arXiv | 2024 | Preprint Only | High |
| RASS | Medical Image Segmentation via Single-Source Domain Generalization with Random Amplitude Spectrum Synthesis | MICCAI 2024 | 2024 | Accepted Conference | High |
| MORESTYLE | MoreStyle: Relax Low-frequency Constraint of Fourier-based Image Reconstruction in Generalizable Medical Image Segmentation | MICCAI 2024 | 2024 | Accepted Conference | High |
| FIESTA | FIESTA: Fourier-Based Semantic Augmentation with Uncertainty Guidance for Enhanced Domain Generalizability in Medical Image Segmentation | arXiv | 2024 | Preprint Only | High |
| SAM_SDG | Leveraging SAM for Single-Source Domain Generalization in Medical Image Segmentation | arXiv | 2024 | Preprint Only | Medium |
| CONSTYX | ConStyX: Content Style Augmentation for Generalizable Medical Image Segmentation | MICCAI 2025 | 2025 | Accepted Conference | High |
| SRCSM | Semantic-aware Random Convolution and Source Matching for Domain Generalization in Medical Image Segmentation | arXiv | 2025 | Preprint Only | High |
| SEMDIR | Learning Semantic Directions for Feature Augmentation in Domain-Generalized Medical Segmentation | arXiv | 2025 | Preprint Only | High |
| STYCONA | Style Content Decomposition-based Data Augmentation for Domain Generalizable Medical Image Segmentation | arXiv | 2025 | Preprint Only | High |
| DET2PROB | From Deterministic to Probabilistic: A Novel Perspective on Domain Generalization for Medical Image Segmentation | arXiv | 2024 | Preprint Only | Medium |
| HALLUDG | Hallucinated Domain Generalization Network with Domain-aware Dynamic Representation for Medical Image Segmentation | Neural Networks | 2025 | Published Journal | Medium |
| DYNSDG | Dynamic Domain Generalization for Medical Image Segmentation | Neural Networks | 2024 | Published Journal | Medium |
| SI2CRL | Spectrum Intervention based Invariant Causal Representation Learning for Single-domain Generalizable Medical Image Segmentation | Medical Image Analysis | 2025 | Published Journal | High |
| INVCAUSAL | Generalizable Single-Source Cross-modality Medical Image Segmentation via Invariant Causal Mechanisms | arXiv | 2024 | Preprint Only | Medium |
| MCDRL | Multimodal Causal-Driven Representation Learning for Generalizable Medical Image Segmentation | arXiv | 2025 | Preprint Only | Medium |
...
| UNIFREQ | Universal Frequency Domain Perturbation for Single-Source Domain Generalization | ACM MM 2024 | 2024 | Accepted Conference Paper | High |
...
| DGTTA | DG-TTA: Out-of-Domain Medical Image Segmentation Through Augmentation, Descriptor-Driven Domain Generalization, and Test-Time Adaptation | Sensors | 2025 | Published Journal Article | Low |

---

## Category B. 방법론 유사 — Class/Region/Structure-conditioned Augmentation
...
| COLORMAP | Colormap Augmentation: A Novel Method for Cross-Modality Domain Generalization | International Journal of Computer Assisted Radiology and Surgery | 2025 | Published Journal Article | Low |
| SCSD | Exploring Semantic Consistency and Style Diversity for Domain Generalized Semantic Segmentation | AAAI 2025 | 2025 | Accepted Conference Paper | Medium |
...
| KEY | 제목 | Venue | Year | Status | Rel |
|-----|------|-------|------|--------|-----|
| VESSELMORPH | VesselMorph: Domain-Generalized Retinal Vessel Segmentation via Shape-Aware Representation | arXiv/MedIA | 2023 | Published Journal | High |
| MULTIDOMAIN_BRAIN | Multi-Domain Brain Vessel Segmentation Through Feature Disentanglement | MELBA | 2025 | Published Journal | High |
...
| FRACTAL_FFM | Representing Topological Self-Similarity Using Fractal Feature Maps for Accurate Segmentation of Tubular Structures | ECCV 2024 | 2024 | Accepted Conference | Medium |
| SKELRECALL | Skeleton Recall Loss for Connectivity Conserving and Resource Efficient Segmentation of Thin Tubular Structures | ECCV 2024 | 2024 | Accepted Conference | High |
| CBDICE | Centerline Boundary Dice Loss for Vascular Segmentation | MICCAI 2024 | 2024 | Accepted Conference | High |
| CLCE | The Centerline-Cross Entropy Loss for Vessel-Like Structure Segmentation: Better Topology Consistency Without Sacrificing Accuracy | MICCAI 2024 | 2024 | Accepted Conference | High |
| DEEPCLOSING | Deep Closing: Enhancing Topological Connectivity in Medical Tubular Segmentation | IEEE TMI | 2024 | Published Journal | Medium |
...
| URVSM | Universal Vessel Segmentation for Multi-Modality Retinal Images | IEEE TIP | 2025 | Published Journal Article | Medium |
| TOPOFAST | Topology Optimization in Medical Image Segmentation with Fast Euler Characteristic | IEEE TMI | 2025 | Published Journal Article | Medium |
| DEFORMCL | Learning Deformable Centerline Representation for Vessel Extraction in 3D Medical Image | arXiv | 2025 | Preprint Only | Low |
| COLETRA | Disconnect to Connect: A Data Augmentation Method for Improving Topology Accuracy in Image Segmentation | arXiv | 2025 | Preprint Only | **High** |
| TUBEMLLM | TubeMLLM: A Foundation Model for Topology Knowledge Exploration in Vessel-like Anatomy | arXiv | 2026 | Preprint Only | Low |

---

## Category D. Top-tier Vision — 아이디어 전이 가능
...
## Preprint-Only 별도 후보 목록

우수하지만 미출판이라 최상위 추천에서 제외된 논문들.

| KEY | 제목 | arXiv | Year |
|-----|------|-------|------|
| RAFFESDG | RaffeSDG | 2405.01228 | 2024 |
| FIESTA | FIESTA | 2406.14308 | 2024 |
| SAM_SDG | SAM for SSDG | 2401.02076 | 2024 |
| SRCSM | SRCSM | 2512.01510 | 2025 |
| SEMDIR | Learning Semantic Directions | 2507.23326 | 2025 |
| STYCONA | StyCona | 2502.20619 | 2025 |
| DET2PROB | Det2Prob | 2412.05572 | 2024 |
| INVCAUSAL | Invariant Causal Mechanisms | 2411.05223 | 2024 |
| MCDRL | MCDRL | 2508.05008 | 2025 |
| ANGIODG | AngioDG | 2511.17724 | 2025 |
| WAVERNETV | WaveRNet | 2601.05942 | 2026 |
| SDG_REALWORLD | SDG Real World | 2601.16359 | 2026 |
...
| DEFORMCL | Learning Deformable Centerline Representation for Vessel Extraction in 3D Medical Image | 2506.05820 | 2025 |
| COLETRA | Disconnect to Connect: A Data Augmentation Method for Improving Topology Accuracy | 2503.05541 | 2025 |
| TUBEMLLM | TubeMLLM: A Foundation Model for Topology Knowledge Exploration in Vessel-like Anatomy | 2603.09217 | 2026 |
